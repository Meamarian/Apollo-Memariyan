...
locals {
  node_functions = ["Split", "Search", "Addition"]
  function_docker_names = ["Split", "Search", "Addition"]
  function_docker_images = ["ibmfunctions/action-python-v3.7","ibmfunctions/action-python-v3.7","ibmfunctions/action-python-v3.7"]
}
