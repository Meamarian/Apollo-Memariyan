...
locals {
  function_names = ["Split", "Search","TextModify","Addition"]
  function_paths = ["tmp/Split.zip", "tmp/Search.zip","tmp/TextModify.zip" ,"tmp/Addition.zip"]
  function_runtimes = ["python3.8","python3.8","python3.8","python3.8"]
  function_handlers = ["lambda_function.lambda_handler","lambda_function.lambda_handler","lambda_function.lambda_handler","lambda_function.lambda_handler"]
  function_layers = [[],[],[],[]]
}
