...
locals {
  node_functions = ["Split", "Search","TextModify","Addition"]
  function_docker_names = ["Split", "Search","TextModify","Addition"]
  function_docker_images = ["ibmfunctions/action-python-v3.7","ibmfunctions/action-python-v3.7","ibmfunctions/action-python-v3.7","ibmfunctions/action-python-v3.7"]
}
...
output "url_TextModify" {
    value = "${ibm_function_action.functions_docker[2].target_endpoint_url}.json"
}

output "url_Addition" {
    value = "${ibm_function_action.functions_docker[3].target_endpoint_url}.json"
}